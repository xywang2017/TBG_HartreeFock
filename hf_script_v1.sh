...
julia proj/runHF_server.jl 3 11 -0.545 ${2} 07 ${1} ${3} strain symmetric
julia proj/runHF_server.jl 1 4 -0.5 ${2} 07 ${1} ${3} strain symmetric
julia proj/runHF_server.jl 2 9 -0.444 ${2} 07 ${1} ${3} strain symmetric
julia proj/runHF_server.jl 1 5 -0.4 ${2} 07 ${1} ${3} strain symmetric
julia proj/runHF_server.jl 2 11 -0.364 ${2} 07 ${1} ${3} strain symmetric
julia proj/runHF_server.jl 1 6 -0.333 ${2} 07 ${1} ${3} strain symmetric
julia proj/runHF_server.jl 1 7 -0.286 ${2} 07 ${1} ${3} strain symmetric
julia proj/runHF_server.jl 1 8 -0.25 ${2} 07 ${1} ${3} strain symmetric
julia proj/runHF_server.jl 1 9 -0.222 ${2} 07 ${1} ${3} strain symmetric