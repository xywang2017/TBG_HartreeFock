...
# -------------------- non trivial momentum space spin structure factor? -------- # 
plot_contour_maps(kvec,reshape(dm.δs,4,4,4,lk,lk)[4,1,2,:,:],points=ComplexF64[0+0im],contourlines=[100.],limits=Float64[])