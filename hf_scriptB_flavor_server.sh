...
# do 
# 	julia proj/runHF_server.jl 1 5 $nu flavor 07 $1 &
# done

# for nu in {0.0,0.167,0.333,0.5,0.833,1.0,1.167,1.333,2.0,2.167,2.333,3.0,3.167}
# do 
# 	julia proj/runHF_server.jl 1 6 $nu flavor 07 $1 &
# done
