...
params = Params(w1=110,w0=parse(Float64,ARGS[5])*0.1*110,vf=2482,dθ=1.05π/180)
...
if !isequal(flag,"strong")
    ...
    savename0 = joinpath(fpath,"feldman/B/data_w$(w0)/_$(p)_$(q)/$(seed)_random_init_HF_$(p)_$(q)_nu_1400.jld2")
