...
params = Params(ϵ=0.004,Da=-4100,φ=0.0*π/180,dθ=twist_angle*0.01*π/180,w1=110,w0=77,vf=2482)
...
metadata = find_lowest_energy_datafile("$(foldername)/_$(p)_$(q)";test_str="1_bm_cascade_tL_init_HF_$(p)_$(q)_nu_$(νstr)",_printinfo=true)
...
metadata0 = find_lowest_energy_datafile("$(foldername)/_$(p)_$(q)";test_str="tL_init_HF_$(p)_$(q)_nu_$(νstr)",_printinfo=true)
...
plot_density_matrix_strong_coupling_valley_spin_v1_half(metadata,metadata0)
